    ...
    <div>
      ...
      <div className="InputCustom">
        ...
        <input
          type="number"
          onChange={(e: { target: { value: string } }) =>
            changeEventHandler(e.target.value, "price")
          }
          placeholder="Price"
          className="WhiteColorForInputText"
        />
      ...
      <div className="InputCustom">
        ...
        <input
          type="number"
          onChange={(e: { target: { value: string } }) =>
            changeEventHandler(e.target.value, "calories")
          }
      ...
      <div className="InputCustom">
        ...
        <input
          value={dish.cuisine}
          onChange={(e: { target: { value: string } }) =>
            changeEventHandler(e.target.value, "cuisine")
          }
          placeholder="Cuisine"
          className="WhiteColorForInputText"
        />
      ...
      <div className="InputCustom">
        ...
        <input
          onChange={(e: { target: { value: string } }) =>
            changeEventHandler(e.target.value, "img")
          }
          placeholder="URL"
          className="WhiteColorForInputText"
        />
      ...
      <div className="InputCustom">
        ...
        <input
          onChange={(e: { target: { value: string } }) =>
            changeEventHandler(e.target.value, "link")
          }
          placeholder="URL"
          className="WhiteColorForInputText"
        />
