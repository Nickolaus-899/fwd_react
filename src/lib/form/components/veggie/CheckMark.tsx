...
const CheckMark: ({active} : {active: boolean}) => JSX.Element = ({active}) => {
    return (
        <CheckMarkWrapperColor $active={active}>
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                 width="20" height="20" viewBox="0 0 1280.000000 1185.000000" className="CheckMark">
                <g transform="translate(0.000000,1185.000000) scale(0.100000,-0.100000)"
                   fill="#000000" stroke="none">
                    <path d="M12595 11778 c-798 -464 -1551 -977 -2329 -1587 -2298 -1802 -4607
