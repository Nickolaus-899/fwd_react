    ...
    <div className="FoodItemInListPosition">
      ...
      <div className="FoodItemInList">
        ...
        <div className="FoodItemInListInfo">
          ...
          {dish.cuisine !== "" ? <div>cuisine: {dish.cuisine}</div> : null}
